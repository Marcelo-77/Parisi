...
FROM (VALUES
  ...
  ('Improvements-and-Corrections-Control-Search.html', 'Applications_Improvements_Corrections_Search'),
  ...
  ('log-location-product.html', 'Log_location'),
  ('changes-products-between-locations.html', 'Location_Movement_Changes_Products'),
  ('change-between-location-products.html', 'Location_Movement_Change_Between_Location_Products'),
