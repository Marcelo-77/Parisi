// Importa registros de public/data_location.txt na tabela warehouse_locations
// status = active, access_type = Shelf By Fork
...
async function importDataLocation() {
  const filePath = path.join(__dirname, '..', 'public', 'data_location.txt');
